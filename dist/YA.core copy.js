...
(function (factory) {
    ...
    var Observable1 = /** @class */ (function () {
        function Observable1(initial, schema, name, superOb) {
            var _this = this;
            var _a, _b;
            var facade;
            facade = function (value, isSubscriber, capture) {
                if (value === undefined) {
                    return _this.value === Observable1_1 ? _this.old : _this.value;
                }
                else if (value === Observable1_1)
                    return _this;
            ...
            this.value = Observable1_1;
        }
        Observable1_1 = Observable1;
        Observable1.prototype.get = function () {
            return this.value === Observable1_1 ? this.old : this.value;
        };
        Observable1.prototype.set = function (value) {
            this.value = value;
            return this;
        };
        Observable1.prototype.defineProp = function (name, initial) {
            if (this.type === ModelTypes.value) {
            ...
            var result = new Observable1_1(initial, undefined, name, this);
            Object.defineProperty(this.$observable, name, { enumerable: true, configurable: false, writable: false, value: result });
            return result;
        };
        Observable1.prototype.subscribe = function (handler, disposer) {
        ...
        Observable1.prototype.unsubscribe = function (handler) {
            var handlers = this.listeners;
            array_remove(handlers, handler);
            return this;
        };
        Observable1.prototype.capture = function (handler, disposer) {
        ...
        Observable1.prototype.uncapture = function (handler) {
            var handlers = this.captures;
            array_remove(handlers, handler);
            return this;
        };
        Observable1.prototype.update = function (src, removed) {
        ...
        var Observable1_1;
        Observable1 = Observable1_1 = __decorate([
            implicit()
        ], Observable1);
        return Observable1;
    }());
    ...
    function update(evt) {
        var value = this.value === Observable1 ? this.old : this.value;
        if (this.value === Observable1 || this.value === this.old)
            return false;
        if (!evt)
            evt = {};
        evt.value = value;
    ...
    function initObservableObject(facade, initial, schema) {
        ...
        this.update = function (src, removed) {
            ...
            var facade = _this.facade;
            for (var n in facade) {
                facade[n](Observable1).update(evt);
            }
            return _this;
        };
        this.old = initial || {};
        for (var name_5 in schema) {
            var member = new Observable1(this.old[name_5], schema[name_5], this, name_5);
    ...
    function initObservableArray(facade, initial, schema) {
        ...
        this.set = function (value) {
            ...
            for (var i = 0, j = value.length; i < j; i++) {
                ...
                item = new Observable1(value[i], _this.$schema.$item, _this, name_6);
        ...
        this.update = function (src, removed) {
            ...
            for (var i = 0, j = evt.value.length; i < j; i++) {
                var item = facade[i](Observable1);
                item.update(evt);
            }
            for (var i = evt.value.length, j = oldLength; i < j; i++) {
                var n = i.toString();
                var removedItem = facade[n](Observable1);
        ...
        var lengthObservable = new Observable1(this.old.length, lengthSchema, this, 'length');
        ...
        if (initial)
            for (var i = 0, j = initial.length; i < j; i++) {
                ...
                var itemObservable = new Observable1(initial[i], this.schema.$itemSchema, this, name_7);
        ...
        this.subscribe = function (handler, disposer) {
            if (!_this.dep_handler) {
                var callback = _this.dep_handler = function (src) {
                    ...
                    var old = _this.value === Observable1 ? undefined : _this.value;
                    _this.value = Observable1;
                    var value = _this.get();
                    if (old === value)
                        return;
                    var evt = {
            ...
            Observable1.prototype.subscribe.call(handler, disposer);
            return _this;
        };
        this.deps = initial;
    }
    ...
    function bindScopeResolve(bindValue, expandOb) {
        ...
        if (bindValue instanceof ModelSchema) {
            if (bindValue.$type === ModelTypes.constant) {
                return new Observable1(undefined, bindValue, undefined, '<CONSTANT>').$observable;
            }
            else if (bindValue.$type === ModelTypes.computed) {
                return new Observable1(undefined, bindValue, undefined, '<COMPUTED>').$observable;
            }
        ...
        if (expandOb === false) {
            return bindValue && bindValue.$observable ? bindValue.$observable : new Observable1(bindValue, undefined, undefined, '<constant>');
        }
        if (expandOb === true)
    ...
    var ComponentRuntime = /** @class */ (function () {
        ...
        ComponentRuntime.prototype.initialize = function (bindContext) {
            ...
            this.model = new Observable1(undefined, this.meta.modelSchema, Meta.modelname, undefined);
